 ...
 <div class="row">
  ...
  <div class="col-lg-9 col-md-9 col-sm-9 col-12 pt-0 body_top_div">
    ...
    <div class="col-lg-12 col-sm-12">
      <center>
        <img src="image/p_sir.jpg" class="img-fluid" id="dept_head">
      </center>
    </div>
    <hr class="dept_head_imgHR">
    <div class="table-responsive">
      <table class="table table-bordered table-hover" style="font-family:Arial; line-height:25px; color:black;">

        <tbody>
          <tr>
            <td width="100">Name</td>
            <td width="3"> <center>:</center></td>
            <td width="230">Atuar Rahman</td>
          </tr>
          <tr>
            <td>Designation</td>
            <td><center>:</center></td>
            <td>Instructor (Tech)</td>
          </tr>
          <tr>
            <td>Depertment</td>
            <td><center>:</center></td>
            <td>MECHANICAL TECNOLOGY</td>
          </tr>
          <tr>
            <td>Father's Name</td>
            <td><center>:</center></td>
