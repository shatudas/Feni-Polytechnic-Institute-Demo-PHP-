   ...
   <div class="col-lg-9 col-md-9 col-sm-9 col-12 pt-0 body_top_div" >			
    <ul class="list-group p-0">
    	<li  class="list-group-item font-weight-bold bg-success text-light " id="">
    		<center>Laws And Regulations</center>
    	</li>
    </ul>

    <h5 class="float-left p-2">Laws And Regulations</h5>
     <a href="image/Citizen Charter.pdf" class="btn btn-sm btn-danger mt-2" download="Laws And Regulations" >Download</a>   
