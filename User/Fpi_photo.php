   ...
   <ul class="list-group p-0">
    ...
    <li class="list-group-item">
     ...
     <div class="History_text">
      ...
      <div class="row">
       <div class="col-sm-6 col-12 p-1 pt-1">
        <a href="image/FPI.jpg">
         <img src="image/FPI.jpg" alt="" class="img-fluid"  style=" height:170px; width:all;">
        </a>
        <div  style=" position:absolute; z-index:100;  background-color:rgb(46, 39, 30,0.7); width:98%; padding:0px; margin-top:-47px;">
         <p style=" padding-top:10px; text-align:center; color:#fff;">Feni Polytechnic Institute</p>
        </div>
       </div>
