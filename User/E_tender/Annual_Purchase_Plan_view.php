 <div class="container" style="margin-top:70px; padding-top:10px;">
  <div class="row">
   <div class="col-lg-9 col-md-9 col-sm-9 col-12 pt-0 body_top_div" >			
    ...
    <h5 class="float-left p-2">Annual Purchase Plan</h5>
     <a href="image/Citizen Charter.pdf" class="btn btn-sm btn-danger mt-2" download="Annual_Purchase_Plan" >Download</a>   
