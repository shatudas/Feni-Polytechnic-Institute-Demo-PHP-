   ...
   <div class="col-lg-9 col-md-9 col-sm-9 col-12 pt-0 body_top_div" >			
    <ul class="list-group p-0">
    	<li  class="list-group-item font-weight-bold bg-success text-light " id="">
    		<center>Number of created and zero positions</center>
    	</li>
    </ul>

    <h5 class="float-left p-2">Number of created and zero positions</h5>
     <a href="image/orgaogram.pdf" class="btn btn-sm btn-danger mt-2" download="positions" > Download</a>   

    <div class="embed-responsive" style="padding-bottom:150%">
     <div style="width:500px;">
      <iframe src="image/orgaogram.pdf"></iframe> 
     </div>
    </div>
