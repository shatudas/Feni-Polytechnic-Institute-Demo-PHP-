    						...
    						<ul class="list-group p-0">
    							...
    							<li class="list-group-item">
    								<div class="History_text">
    									<p>
                        বিশ্বমানের পলিটেকনিক ইনস্টিটিউটে উন্নীত করণের  লক্ষ্যে মান সম্মত শিক্ষা ও প্রশিক্ষণ প্রদান, প্রয়োজনীয় নীতি, কর্মসূচী প্রকল্প বাস্তবায়ন, আদর্শমান নির্ধারণ ও পরীক্ষণ এবং মূল্যায়ন।         
                      </p>
    									<p>Provide quality education and training to promote world class polytechnic institutes, implement necessary policies, program projects, set standards and test and</p>
