   ...
   <div class="col-lg-9 col-md-9 col-sm-9 col-12 pt-0 body_top_div" >
     ...
     <ul class="list-group p-0">
      ...
      <li class="list-group-item" >
        ...
        <div class="col-lg-12 col-md-12 col-12 shop_div">
          <div class="row">
            <div class="col-md-3 col-3 mt-3">
             <img src="image/shop.jpg" class="img-fluid" id="shop_img" >  
            </div>

            <div class="col-md-9 col-9 mt-3">
              <h5>
                <span class="shop_text_1" style="">Name of the lab / shop :</span><label class="shop_text_2">&nbsp; Electrical Circuit Lab</label>
              </h5>
              <span  class="shop_text_3">Details :</span><label class="shop_text_4">&nbsp; Electrical Circuit Lab</label>
